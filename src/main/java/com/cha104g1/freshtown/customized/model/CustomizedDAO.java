...
public class CustomizedDAO implements CustomizedDAOIntf{
	...
	private static final String INSERT_STMT = "INSERT INTO customized (mealNo,custedItemsNo,custedStatus) VALUES (?, ?, ?)";
	private static final String GET_ALL_STMT = "SELECT mealNo,custedItemsNo,custedStatus FROM customized order by mealNo,custedItemsNo";
	private static final String GET_ONE_STMT = "SELECT mealNo,custedItemsNo,custedStatus FROM customized where mealNo = ? && custedItemsNo = ?";
	private static final String UPDATE = "UPDATE customized set mealNo=?, custedItemsNo=?, custedStatus=? where mealNo = ? && custedItemsNo= ?";
	...
	public void insert(CustomizedVO customizedVO) {
		...
		try {
			...
			pstmt.setInt(3, customizedVO.getCustedStatus());
			pstmt.executeUpdate();
